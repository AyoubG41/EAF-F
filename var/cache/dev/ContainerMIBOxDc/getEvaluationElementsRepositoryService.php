...
// Returns the private 'App\Repository\EvaluationElementsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EvaluationElementsRepository.php';

return $this->privates['App\\Repository\\EvaluationElementsRepository'] = new \App\Repository\EvaluationElementsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
