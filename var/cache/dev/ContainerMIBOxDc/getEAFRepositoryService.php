...
// Returns the private 'App\Repository\EAFRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EAFRepository.php';

return $this->privates['App\\Repository\\EAFRepository'] = new \App\Repository\EAFRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
