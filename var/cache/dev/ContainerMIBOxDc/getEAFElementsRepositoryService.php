...
// Returns the private 'App\Repository\EAFElementsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EAFElementsRepository.php';

return $this->privates['App\\Repository\\EAFElementsRepository'] = new \App\Repository\EAFElementsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
