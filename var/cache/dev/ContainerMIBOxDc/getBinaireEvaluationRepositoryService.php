...
// Returns the private 'App\Repository\BinaireEvaluationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BinaireEvaluationRepository.php';

return $this->privates['App\\Repository\\BinaireEvaluationRepository'] = new \App\Repository\BinaireEvaluationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
