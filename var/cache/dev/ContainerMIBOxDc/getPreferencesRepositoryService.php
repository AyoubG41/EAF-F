...
// Returns the private 'App\Repository\PreferencesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PreferencesRepository.php';

return $this->privates['App\\Repository\\PreferencesRepository'] = new \App\Repository\PreferencesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
