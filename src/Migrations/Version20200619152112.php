 ...
 */
final class Version20200619152112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE etape (id INT AUTO_INCREMENT NOT NULL, value TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE eaf ADD evaluation_element_id INT NOT NULL, CHANGE version version VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE eaf ADD CONSTRAINT FK_696A4E52F5186DD6 FOREIGN KEY (evaluation_element_id) REFERENCES evaluation_elements (id)');
        $this->addSql('CREATE INDEX IDX_696A4E52F5186DD6 ON eaf (evaluation_element_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eaf DROP evaluation_element_id, CHANGE version version VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
