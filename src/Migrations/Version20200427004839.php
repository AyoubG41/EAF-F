 ...
 */
final class Version20200427004839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eaf ADD createur_id INT NOT NULL, CHANGE version version VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE eaf ADD CONSTRAINT FK_696A4E5273A201E5 FOREIGN KEY (createur_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_696A4E5273A201E5 ON eaf (createur_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eaf DROP FOREIGN KEY FK_696A4E5273A201E5');
        $this->addSql('DROP INDEX IDX_696A4E5273A201E5 ON eaf');
        $this->addSql('ALTER TABLE eaf DROP createur_id, CHANGE version version VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
       // $this->addSql('ALTER TABLE eafelements CHANGE eaf_id eaf_id INT DEFAULT NULL, CHANGE expert_id expert_id INT DEFAULT NULL, CHANGE parent_id parent_id INT DEFAULT NULL');
