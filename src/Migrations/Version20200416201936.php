 ...
 */
final class Version20200416201936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation_elements ADD team_validate LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE parent_id parent_id INT DEFAULT NULL, CHANGE entreprise_id entreprise_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation_elements DROP team_validate, CHANGE parent_id parent_id INT DEFAULT NULL, CHANGE entreprise_id entreprise_id INT DEFAULT NULL');
        //  $this->addSql('ALTER TABLE mapping CHANGE expert_id expert_id INT DEFAULT NULL, CHANGE eafelement_id eafelement_id INT DEFAULT NULL, CHANGE evaluation_element_id evaluation_element_id INT DEFAULT NULL');
