 ...
 */
final class Version20200613220310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eaf ADD entreprise_id INT NOT NULL, CHANGE version version VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE eaf ADD CONSTRAINT FK_696A4E52A4AEAFEA FOREIGN KEY (entreprise_id) REFERENCES entreprise (id)');
        $this->addSql('CREATE INDEX IDX_696A4E52A4AEAFEA ON eaf (entreprise_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eaf DROP FOREIGN KEY FK_696A4E52A4AEAFEA');
        $this->addSql('DROP INDEX IDX_696A4E52A4AEAFEA ON eaf');
        $this->addSql('ALTER TABLE eaf DROP entreprise_id, CHANGE version version VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
